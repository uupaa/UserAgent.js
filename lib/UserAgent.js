...
function UserAgent(userAgent, // @arg String = navigator.userAgent
    ...
    this._MOBILE            = /Android|iOS/.test(os) || /Windows Phone/.test(ua) || !!carrier;
    this._USER_AGENT        = ua;
    this._LANGUAGE          = lang;
...
UserAgent["prototype"] = Object.create(UserAgent, {
    ...
    "OS":               { "get":   function()  { return this._OS;               } }, // "iOS", "Mac", "Android", "Windows", "Firefox", "Chrome OS", ""
    ...
    "iOS":              { "get":   function()  { return this._OS === "iOS";              } }, // is iOS (iPhone or iPad or iPod)
    "Mac":              { "get":   function()  { return this._OS === "Mac";              } }, // is Mac OS X
    "Android":          { "get":   function()  { return this._OS === "Android";          } }, // is Android
    "Windows":          { "get":   function()  { return this._OS === "Windows";          } }, // is Windows
    // --- iOS device short-hand properties ---
    "iPod":             { "get":   function()  { return /iPod/.test(this._USER_AGENT);   } }, // is iPod
    "iPad":             { "get":   function()  { return /iPad/.test(this._USER_AGENT);   } }, // is iPad
    "iPhone":           { "get":   function()  { return /iPhone/.test(this._USER_AGENT); } }, // is iPhone
...
function _getiOSDevice(ua, retina, longEdge, osVersion) {
  ...
  //var SGX535 = /535/.test(glVersion); // iPhone 3GS, iPhone 4
    ...
    var A9     = /A9/.test(glVersion);  // A9,  iPhone 6s/6s+/SE
    ...
    if (/iPhone/.test(ua)) {
        ...
        return !retina         ? "iPhone 3GS"
             ...
             : longEdge <= 568 ? (A9     ? "iPhone SE" :             // iPhone SE or iPhone 6s (zoom)
                                  A8     ? "iPhone 6"   :            // iPhone 6  (zoom)
                                  A7     ? "iPhone 5s"  :            // iPhone 5s
                                  SGX543 ? "iPhone 5"                // iPhone 5   or iPhone 5c
                                         : "iPhone x")               // Unknown iPhone
             : longEdge <= 667 ? (A9     ? "iPhone 6s"  :            // iPhone 6s  or iPhone 6s+ (zoom)
                                  A8     ? "iPhone 6"                // iPhone 6   or iPhone 6+  (zoom)
                                         : "iPhone x")               // Unknown iPhone
