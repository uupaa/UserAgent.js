...
function _getiOSDevice(ua, retina, longEdge, osVersion) {
  ...
  //var SGX535 = /535/.test(glVersion); // iPhone 3GS, iPhone 4
    ...
    // | iPhone 4/4s/5/5c/5s/5se  |      | 568      |   320 x 568    |
    ...
    // | iPad 3/4/Air/mini2       |      | 1024     |   768 x 1024   |
    ...
    if (/iPhone/.test(ua)) {
        ...
        return !retina         ? "iPhone 3GS"
             ...
             : longEdge <= 568 ? (A9     ? "iPhone 5se" :            // iPhone 5se or iPhone 6s (zoom)
