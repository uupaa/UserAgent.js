...
function UserAgent(userAgent, // @arg String = navigator.userAgent
    ...
    this._BASE_BROWSER      = baseBrowser;
    this._BROWSER_ENGINE    = BROWSER_ENGINES[this._BASE_BROWSER] || "";
    ...
    this._iPod              = this._iOS && /iPod/.test(ua);
    this._iPad              = this._iOS && /iPad/.test(ua);
    this._iPhone            = this._iOS && /iPhone/.test(ua);
    this._USER_AGENT        = ua;
    this._LANGUAGE          = lang;
...
UserAgent["parse"]       = UserAgent_parse;
...
UserAgent["prototype"] = Object.create(UserAgent, {
    ...
    "BROWSER":          { "get":   function()  { return this._BROWSER;          } }, // Browser Name.   "Chrome", "Firefox", "IE", "Edge", "AOSP", "Safari", "WebKit", "Chrome for iOS", "Silk", ""
    "BASE_BROWSER":     { "get":   function()  { return this._BASE_BROWSER;     } }, // Base Name.      "Chromium", "Firefox", "IE", "Edge", "WebKit"
    ...
    "macOS":            { "get":   function()  { return this._OS === "Mac";     } }, // is macOS. [alias]
    ...
    // --- browser and flavor ---
    "IE":               { "get":   function()  { return this._BROWSER      === "IE";       } },
    "Edge":             { "get":   function()  { return this._BROWSER      === "Edge";     } },
    "WebKit":           { "get":   function()  { return this._BASE_BROWSER === "WebKit";   } },
    "Firefox":          { "get":   function()  { return this._BROWSER      === "Firefox";  } },
    "Chrome":           { "get":   function()  { return this._BROWSER      === "Chrome";   } },
    "Chromium":         { "get":   function()  { return this._BASE_BROWSER === "Chromium"; } },
    "Safari":           { "get":   function()  { return this._BROWSER      === "Safari";   } },
    "AOSP":             { "get":   function()  { return this._BROWSER      === "AOSP";     } }, // is AOSP Stock Browser. (WebKit Based browser)
    "Silk":             { "get":   function()  { return this._BROWSER      === "Silk";     } }, // is Kindle Silk Browser. (WebKit or Blink based browser)
    // --- device ---
    "iPod":             { "get":   function()  { return this._iPod;             } }, // is iPod
    "iPad":             { "get":   function()  { return this._iPad;             } }, // is iPad
    "iPhone":           { "get":   function()  { return this._iPhone;           } }, // is iPhone
    "Kindle":           { "get":   function()  { return this._BROWSER === "Silk"; } }, // is Kindle
...
function UserAgent_parse(userAgent, // @arg String = navigator.userAgent
                         options) { // @arg Object = {} - { WEB_VIEW, DISPLAY_DPR, DISPLAY_LONG, DISPLAY_SHORT }
                                    // @ret UserAgent instance
    if (UserAgent["cache"]) {
        return UserAgent["cache"]; // return cached instance
    }

    // create new Instance
    var result = new UserAgent(userAgent, options);

    UserAgent["cache"] = result;
    return result;
}
